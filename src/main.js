...
function getHeader() {
    return "<!DOCTYPE html>\n"
         ...
         + "      p.telephone, p.date, p.email { font-size: 2em; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;}\n"
         + "      table { border-collapse: collapse; border-top: 2px solid #000; }\n"
         + "      td { padding-top: 0em; padding-bottom: 0.5em; vertical-align: top;  font-size: 2em; }\n"
         + "      tr.title-row > td { padding-top: 1em;}\n"
         + "      tr.barcode-row > td { border-bottom: 2px solid #000; padding-bottom: 1em; }\n"
